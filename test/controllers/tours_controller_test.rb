...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { Date_of_tour: @tour.Date_of_tour, Time_of_tour: @tour.Time_of_tour, Type_of_tour: @tour.Type_of_tour }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { Date_of_tour: @tour.Date_of_tour, Time_of_tour: @tour.Time_of_tour, Type_of_tour: @tour.Type_of_tour }
    assert_redirected_to tour_path(assigns(:tour))
  end
